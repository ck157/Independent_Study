...
x_1_bs <- as.numeric(total_calls_European$forward_price[training_start:training_end])
x_2_bs <- as.numeric(total_calls_European$strike_price[training_start:training_end])
x_3_bs <- as.numeric(total_calls_European$impl_volatility[training_start:training_end])
x_4_bs <- as.numeric(total_calls_European$time_to_exp[training_start:training_end])
x_5_bs <- as.numeric(total_calls_European$dividend_yield[training_start:training_end])
x_6_bs <- as.numeric(total_calls_European$interest_rate[training_start:training_end])
...
total_calls_European$strike_price_scaled <- range01(total_calls_European$strike_price)
