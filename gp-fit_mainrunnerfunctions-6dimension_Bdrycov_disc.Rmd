...
plot(log(blackscholes_2),log(stan_dat$total_puts_American$mid_price[test_start:test_end]), xlim = c(min(log(blackscholes_2),na.rm=TRUE), max(log(blackscholes_2),na.rm=TRUE)),ylim = c(min(log(stan_dat$total_puts_American$mid_price[test_start:test_end])), max(log(stan_dat$total_puts_American$mid_price[test_start:test_end]))))
abline(0,1)
...
dim1 <- seq(0,1,length.out = 25)
dim2 <- seq(0,1,length.out = 25)
