...
x2_bs <- cbind(as.numeric(stan_dat$total_calls_American$forward_price[test_start:test_end]),as.numeric(stan_dat$total_calls_American$strike_price[test_start:test_end]),as.numeric(stan_dat$total_calls_American$impl_volatility[test_start:test_end]),as.numeric(stan_dat$total_calls_American$time_to_exp[test_start:test_end]),x.grid_5 <- as.numeric(stan_dat$total_calls_American$dividend_yield[test_start:test_end]),as.numeric(stan_dat$total_calls_American$interest_rate[test_start:test_end]))
...
plot(log(y_mean_values_SGP),log(stan_dat$total_calls_American$mid_price[test_start:test_end]),xlim = c(min(log(y_mean_values_SGP),na.rm = TRUE), max(log(y_mean_values_SGP),na.rm = TRUE)),ylim = c(min(log(stan_dat$total_calls_American$mid_price[test_start:test_end])), max(log(stan_dat$total_calls_American$mid_price[test_start:test_end])))) 
abline(0,1)

#Plotting BDrycov
plot(log(y_mean_values_Bdrycov),log(stan_dat$total_calls_American$mid_price[test_start:test_end]), xlim = c(min(log(y_mean_values_Bdrycov),na.rm=TRUE), max(log(y_mean_values_Bdrycov),na.rm=TRUE)),ylim = c(min(log(stan_dat$total_calls_American$mid_price[test_start:test_end])), max(log(stan_dat$total_calls_American$mid_price[test_start:test_end]))))
abline(0,1)

#Plotting Blackscholes
plot(log(blackscholes_test),log(stan_dat$total_calls_American$mid_price[test_start:test_end]), xlim = c(min(log(blackscholes_test),na.rm=TRUE), max(log(blackscholes_test),na.rm=TRUE)),ylim = c(min(log(stan_dat$total_calls_American$mid_price[test_start:test_end])), max(log(stan_dat$total_calls_American$mid_price[test_start:test_end]))))
abline(0,1)
...
x.grid_3_cont <- as.numeric(rep(mean(stan_dat$total_calls_American$impl_volatility_scaled[test_start:test_end])),nrow(X.grid))
x.grid_4_cont <- as.numeric(rep(mean(stan_dat$total_calls_American$time_to_exp_scaled[test_start:test_end])),nrow(X.grid))
x.grid_5_cont <- as.numeric(rep(mean(stan_dat$total_calls_American$dividend_yield_scaled[test_start:test_end])),nrow(X.grid))
x.grid_6_cont <- as.numeric(rep(mean(stan_dat$total_calls_American$interest_rate_scaled[test_start:test_end])),nrow(X.grid))
...
x.grid_3_cont_bs <- as.numeric(rep(mean(stan_dat$total_calls_American$impl_volatility[test_start:test_end])),nrow(X.grid))
x.grid_4_cont_bs <- as.numeric(rep(mean(stan_dat$total_calls_American$time_to_exp[test_start:test_end])),nrow(X.grid))
x.grid_5_cont_bs <- as.numeric(rep(mean(stan_dat$total_calls_American$dividend_yield[test_start:test_end])),nrow(X.grid))
x.grid_6_cont_bs <- as.numeric(rep(mean(stan_dat$total_calls_American$interest_rate[test_start:test_end])),nrow(X.grid))
...
x.grid_3_cont <- as.numeric(rep(mean(stan_dat$total_calls_American$forward_price_scaled[test_start:test_end])),nrow(X.grid))
x.grid_4_cont <- as.numeric(rep(mean(stan_dat$total_calls_American$strike_price_scaled[test_start:test_end])),nrow(X.grid))
x.grid_5_cont <- as.numeric(rep(mean(stan_dat$total_calls_American$dividend_yield_scaled[test_start:test_end])),nrow(X.grid))
x.grid_6_cont <- as.numeric(rep(mean(stan_dat$total_calls_American$interest_rate_scaled[test_start:test_end])),nrow(X.grid))
...
x.grid_3_cont_bs <- as.numeric(rep(mean(stan_dat$total_calls_American$forward_price[test_start:test_end])),nrow(X.grid))
x.grid_4_cont_bs <- as.numeric(rep(mean(stan_dat$total_calls_American$strike_price[test_start:test_end])),nrow(X.grid))
x.grid_5_cont_bs <- as.numeric(rep(mean(stan_dat$total_calls_American$dividend_yield[test_start:test_end])),nrow(X.grid))
x.grid_6_cont_bs <- as.numeric(rep(mean(stan_dat$total_calls_American$interest_rate[test_start:test_end])),nrow(X.grid))
...
x.grid_3_cont <- as.numeric(rep(mean(stan_dat$total_calls_American$impl_volatility_scaled[test_start:test_end])),nrow(X.grid))
x.grid_4_cont <- as.numeric(rep(mean(stan_dat$total_calls_American$time_to_exp_scaled[test_start:test_end])),nrow(X.grid))
x.grid_5_cont <- as.numeric(rep(mean(stan_dat$total_calls_American$forward_price_scaled[test_start:test_end])),nrow(X.grid))
x.grid_6_cont <- as.numeric(rep(mean(stan_dat$total_calls_American$strike_price_scaled[test_start:test_end])),nrow(X.grid))
...
x.grid_3_cont_bs <- as.numeric(rep(mean(stan_dat$total_calls_American$impl_volatility[test_start:test_end])),nrow(X.grid))
x.grid_4_cont_bs <- as.numeric(rep(mean(stan_dat$total_calls_American$time_to_exp[test_start:test_end])),nrow(X.grid))
x.grid_5_cont_bs <- as.numeric(rep(mean(stan_dat$total_calls_American$forward_price[test_start:test_end])),nrow(X.grid))
x.grid_6_cont_bs <- as.numeric(rep(mean(stan_dat$total_calls_American$strike_price[test_start:test_end])),nrow(X.grid))
...
plot(log(y_mean_values_Bdrycov_disc),log(stan_dat$total_calls_American$mid_price[test_start:test_end]), xlim = c(min(log(y_mean_values_Bdrycov_disc),na.rm=TRUE), max(log(y_mean_values_Bdrycov_disc),na.rm=TRUE)),ylim = c(min(log(stan_dat$total_calls_American$mid_price[test_start:test_end])), max(log(stan_dat$total_calls_American$mid_price[test_start:test_end]))))
abline(0,1)
