...
x_4 <- as.numeric(total_puts_European_American$time_to_exp[c(training_start_European:training_end_European,training_start_American:training_end_American)]*250)
