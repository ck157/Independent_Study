...
pred_gp_bs_backtest <- stan(file="Predictive GP_6dimension_withBS_SGP_Delta.stan", data=post_data_bs_American_backtest,iter=200, warmup=0, chains=1, seed=5838298, refresh=100, algorithm = 'Fixed_param')
```
...
vector_k <- matrix(vector_k_values, 71, 322, byrow=TRUE)
