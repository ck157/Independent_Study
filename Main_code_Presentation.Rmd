...
4-3: Contour Plots of Strike Price and Implied Volatility
...
## Part 5: Standard Deviation of Predicted Values
...
par(mfrow = c(1, 2))
#Contour for Predictions aka mean values of predicitons
contour(dim1, dim2, matrix(Discrepancy_function, length(dim1), length(dim2)), labcex =1, main = "Discrepancy Modeling in 2D (Impl_vol & Time_to_Exp)", xlab= "Forward Price", ylab="Strike Price")
points(x2_cont[,1], x2_cont[,2], pch = 19, cex = 0.5, col = "red")
```
...
par(mfrow = c(1, 2))
#Contour for Predictions aka mean values of predicitons
contour(dim1, dim2, matrix(Discrepancy_function, length(dim1), length(dim2)), labcex =1, main = "Discrepancy Modeling in 2D (Strike Price & Impl_vol)", xlab= "Forward Price", ylab="Strike Price")
points(x2_cont[,1], x2_cont[,2], pch = 19, cex = 0.5, col = "red")
```
