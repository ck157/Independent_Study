...
vector_k_2 <- matrix(vector_k_values_2, nrow(x2_backtest_2), nrow(stan_dat$x), byrow=FALSE)
...
vector_k_3 <- matrix(vector_k_values_3, nrow(x2_backtest_3), nrow(stan_dat$x), byrow=FALSE)
...
vector_k_4 <- matrix(vector_k_values_4, nrow(x2_backtest_4), nrow(stan_dat$x), byrow=FALSE)
...
vector_k_5 <- matrix(vector_k_values_5, nrow(x2_backtest_5), nrow(stan_dat$x), byrow=FALSE)
...
##Averaging out delta-hedge performance -> delta hedge for one week then average the profit/loss of the delta hedge for the test week

##Will need to add each passed day into the training data for the BSGP model when delta hediging for the test week
