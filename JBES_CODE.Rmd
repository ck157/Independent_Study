...
colors<-col.pal(100)
z <-  matrix(y_mean_values_cont_SGP, length(dim1), length(dim2))
...
library(base)
persp(dim1, dim2, z, phi = 45, theta = 315, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab="Spot Price", ylab = "Strike Price", zlab = "Average Price", main = "SGP Means (Spot Price & Strike Price)")

#Contour of Variance
col.pal<-colorRampPalette(c("blue", "yellow"))
colors<-col.pal(100)
z <-  matrix(y_sd_values_cont_SGP, length(dim1), length(dim2))
...
persp(dim1, dim2, z, phi = 45, theta = 135,  border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab="Spot Price", ylab = "Strike Price", zlab = "Standard Deviation", main = "SGP Standard Deviation (Spot Price & Strike Price)")
...
col.pal<-colorRampPalette(c("blue", "red"))
colors<-col.pal(100)
z <-  matrix(y_mean_values_cont_bs, length(dim1), length(dim2))
...
persp(dim1, dim2, z, phi = 45, theta = 315, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab="Spot Price", ylab = "Strike Price", zlab = "Average Price", main = "BSGP Means (Spot Price & Strike Price)")
#Contour of Variance
col.pal<-colorRampPalette(c("blue", "yellow"))
colors<-col.pal(100)
z <-   matrix(y_sd_values_cont_bs, length(dim1), length(dim2))
...
persp(dim1, dim2,z, phi = 45, theta = 135, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab="Spot Price", ylab = "Strike Price", zlab = "Standard Deviation", main = "BSGP Standard Deviation (Spot Price & Strike Price)")
par(mfrow = c(1, 2))
#Contour for Predictions aka mean values of predicitons
col.pal<-colorRampPalette(c("blue", "red"))
colors<-col.pal(100)
z <-   matrix(blackscholes_test_cont, length(dim1), length(dim2))
...
persp(dim1, dim2,z, phi = 45, theta = 315, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab="Spot Price", ylab = "Strike Price", zlab = "Average Price", main = "BlackScholes Average Price (Spot Price & Strike Price)")
#Contour of Variance
...
persp(dim1, dim2,z,phi = 45, theta = 180, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed", xlab="Implied Volatility", ylab = "Time to Expiration", zlab = "Average Price", main = "SGP Average Price (Impl_vol & Time_to_Exp)")
#Contour of Variance
z <-  matrix(y_sd_values_cont_SGP, length(dim1), length(dim2))
...
persp(dim1, dim2,z, phi = 45, theta = 45, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed", xlab="Implied Volatility", ylab = "Time to Expiration", zlab = "Standard Deviation", main = "SGP Standard Deviation (Impl_vol & Time_to_Exp)")
...
persp(dim1, dim2,z, phi = 45, theta = 45, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed", xlab="Implied Volatility", ylab = "Time to Expiration", zlab = "Average Price", main = "BSGP Average Price (Impl_vol & Time_to_Exp)")
#Contour of Variance
z <-  matrix(y_sd_values_cont_bs, length(dim1), length(dim2))
...
persp(dim1, dim2, z, phi = 45, theta = 45, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed", xlab="Implied Volatility", ylab = "Time to Expiration", zlab = "Standard Deviation", main = "BSGP Standard Deviation (Impl_vol & Time_to_Exp)")
...
persp(dim1, dim2,z, phi = 45, theta = 45, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab="Implied Volatility", ylab = "Time to Expiration", zlab = "Average Price", main = "Blackscholes Average Price (Impl_vol & Time_to_Exp)")
#Contour of Variance
```
...
persp(dim1, dim2, z, phi = 45, theta = 315, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab="Strike Price", ylab = "Implied Volatility", zlab = "Average Price", main = "SGP Average Price (Strike Price & Impl_vol)")
#Contour of Variance
z <-  matrix(y_sd_values_cont_SGP, length(dim1), length(dim2))
...
persp(dim1, dim2,z, phi = 45, theta = 315, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed", xlab="Strike Price", ylab = "Implied Volatility", zlab = "Standard Deviation", main = "SGP Standard Deviation (Strike Price & Impl_vol)")
...
persp(dim1, dim2, z, phi = 45, theta = 315, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed" ,xlab="Strike Price", ylab = "Implied Volatility", zlab = "Average Price", main = "BSGP Average Price (Strike Price & Impl_vol)")
#Contour of Variance
z <-  matrix(y_sd_values_cont_bs, length(dim1), length(dim2))
...
persp(dim1, dim2, z,phi = 45, theta = 315, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab="Strike Price", ylab = "Implied Volatility", zlab = "Standard Deviation", main = "BSGP Standard Deviation (Strike Price & Impl_vol)")
...
persp(dim1, dim2,z , phi = 45, theta = 315, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab="Strike Price", ylab = "Implied Volatility", zlab = "Average Price", main = "Blackscholes Average Price (Strike Price & Impl_vol)")
#Contour of Variance
...
par(mfrow = c(1, 2))
#Contour for Predictions aka mean values of predicitons
col.pal<-colorRampPalette(c("red", "yellow"))
colors<-col.pal(100)
z <- matrix(Discrepancy_function, length(dim1), length(dim2))
...
persp(dim1, dim2,z , phi = 45, theta = 45, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab= "Spot Price", ylab="Strike Price", zlab = "Average Price", main = "Discrepancy Modeled in 3D (Spot Price & Strike Price)")
...
persp(dim1, dim2,z , phi = 45, theta = 45, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab= "Implied Volatility", ylab="Time to Expiration", zlab = "Average Price", main = "Discrepancy Modeling in 3D (Impl_vol & Time_to_Exp)")
...
persp(dim1, dim2,z , phi = 45, theta = 45, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab= "Strike Price", ylab="Implied Volatility", zlab = "Average Price", main ="Discrepancy Modeling in 3D (Strike Price & Impl_vol)")
...
col.pal<-colorRampPalette(c("blue", "red"))
colors<-col.pal(100)
z <-  matrix(BSGP_Delta_cont, length(dim1), length(dim2))
...
persp(dim1, dim2, z, phi = 45, theta = 235, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab="Spot Price", ylab = "Strike Price", zlab = "Delta", main = "BSGP Deltas (Spot Price & Strike Price)")
...
col.pal<-colorRampPalette(c("blue", "red"))
colors<-col.pal(100)
z <-   matrix(BS_Delta_cont, length(dim1), length(dim2))
...
persp(dim1, dim2,z, phi = 45, theta = 235, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab="Spot Price", ylab = "Strike Price", zlab = "Delta", main = "BlackScholes Deltas (Spot Price & Strike Price)")
...
col.pal<-colorRampPalette(c("red", "yellow"))
colors<-col.pal(100)
z <-  matrix(Delta_disc, length(dim1), length(dim2))
...
persp(dim1, dim2, z, phi = 45, theta = 235, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab="Spot Price", ylab = "Strike Price", zlab = "Delta Discrepancy", main = "Delta Discrepancies (Spot Price & Strike Price)")
...
persp(dim1, dim2, z, phi = 45, theta = 225, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab="Implied Volatility", ylab = "Time to Expiration", zlab = "Delta", main = "BSGP Deltas (Implied_vol & Time_to_exp)")
...
persp(dim1, dim2, z, phi = 45, theta = 235, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab="Implied VOlatility", ylab = "Time to Expiration", zlab = "Delta Discrepancy", main = "Delta Discrepancies (Impl_vol & Time_to_exp)")
```
...
persp(dim1, dim2, z, phi = 45, theta = 225, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab="Strike Price", ylab = "Implied Volatility", zlab = "Delta", main = "BSGP Deltas (Strike Price & Impl_vol)")
...
persp(dim1, dim2, z, phi = 45, theta = 235, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab="Strike Price", ylab = "Implied Volatility", zlab = "Delta Discrepancy", main = "Delta Discrepancies (Strike Price & Impl_vol)")
```
