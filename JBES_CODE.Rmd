...
fig_sgp_price <- plot_ly(x=dim1*(max_spot-min_spot)+min_spot, y=dim2*(max_strike-min_strike)+min_strike, z=matrix(y_mean_values_cont_SGP, length(dim1*(max_spot-min_spot)+min_spot), length(dim2*(max_strike-min_strike)+min_strike)), type='surface',surfacecolor=color, colorscale='YlGnBu', cauto=F, cmin = min(y_mean_values_cont_SGP), cmax=max(y_mean_values_cont_SGP))
...
fig_sgp_price <- fig_sgp_price %>% layout(title = 'SGP', 
  scene = list(xaxis = list(title='Spot Price'), yaxis = list(title='Strike Price'), zaxis= list(title='Predicted Price', range = c(min(y_mean_values_cont_SGP),max(y_mean_values_cont_SGP))),camera = list(
...
fig_sgp_sd <- plot_ly(x=dim1*(max_spot-min_spot)+min_spot, y=dim2*(max_strike-min_strike)+min_strike, z=matrix(y_sd_values_cont_SGP, length(dim1*(max_spot-min_spot)+min_spot), length(dim2*(max_strike-min_strike)+min_strike)), type='surface',surfacecolor=color, colorscale = 'YlOrRd',cauto=F, cmin = min(y_sd_values_cont_SGP), cmax=max(y_sd_values_cont_SGP))
...
fig_sgp_sd <- fig_sgp_sd %>% layout(title = 'SGP', 
  scene = list(xaxis = list(title='Spot Price'), yaxis = list(title='Strike Price'), zaxis= list(title='Standard Deviation', range = c(0,max(y_sd_values_cont_SGP))),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
)
...
fig_bs_price <- plot_ly(x=dim1*(max_spot-min_spot)+min_spot, y=dim2*(max_strike-min_strike)+min_strike, z=matrix(y_mean_values_cont_bs, length(dim1*(max_spot-min_spot)+min_spot), length(dim2*(max_strike-min_strike)+min_strike)), type='surface',surfacecolor=color, colorscale='YlGnBu',cauto=F, cmin = min(y_mean_values_cont_SGP), cmax=max(y_mean_values_cont_SGP))
...
fig_bs_sd <- plot_ly(x=dim1*(max_spot-min_spot)+min_spot, y=dim2*(max_strike-min_strike)+min_strike, z=matrix(y_sd_values_cont_bs, length(dim1*(max_spot-min_spot)+min_spot), length(dim2*(max_strike-min_strike)+min_strike)), type='surface',surfacecolor=color, colorscale='YlOrRd',cauto=F, cmin = min(y_sd_values_cont_SGP), cmax=max(y_sd_values_cont_SGP))
...
fig_blackscholes_price <- plot_ly(x=dim1*(max_spot-min_spot)+min_spot, y=dim2*(max_strike-min_strike)+min_strike, z=matrix(blackscholes_test_cont, length(dim1*(max_spot-min_spot)+min_spot), length(dim2*(max_strike-min_strike)+min_strike)), type='surface',surfacecolor=color, colorscale='YlGnBu', cauto=F, cmin = min(y_mean_values_cont_SGP), cmax=max(y_mean_values_cont_SGP))
...
fig_sgp_price <- plot_ly(x=dim1*(max_impl_vol-min_impl_vol)+min_impl_vol, y=dim2*(max_time-min_time)+min_time, z=matrix(y_mean_values_cont_SGP, length(dim1*(max_impl_vol-min_impl_vol)+min_impl_vol), length(dim2*(max_time-min_time)+min_time)), type='surface',surfacecolor=color, colorscale='YlGnBu', cauto=F, cmin = min(y_mean_values_cont_SGP), cmax=max(y_mean_values_cont_SGP))
...
fig_sgp_price <- fig_sgp_price %>% layout(title = 'SGP', 
  scene = list(xaxis = list(title='Implied Volatility'), yaxis = list(title='Time to Expiration'), zaxis= list(title='Predicted Price', range = c(min(y_mean_values_cont_SGP),max(y_mean_values_cont_SGP))),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
)
...
fig_sgp_sd <- plot_ly(x=dim1*(max_impl_vol-min_impl_vol)+min_impl_vol, y=dim2*(max_time-min_time)+min_time, z=matrix(y_sd_values_cont_SGP, length(dim1*(max_impl_vol-min_impl_vol)+min_impl_vol), length(dim2*(max_time-min_time)+min_time)), type='surface',surfacecolor=color,colorscale='YlOrRd', cauto=F, cmin = min(y_sd_values_cont_SGP), cmax=max(y_sd_values_cont_SGP))
...
fig_sgp_sd <- fig_sgp_sd %>% layout(title = 'SGP', 
  scene = list(xaxis = list(title='Implied Volatility'), yaxis = list(title='Time to Expiration'), zaxis= list(title='Standard Deviation', range = c(min(y_mean_values_cont_SGP),max(y_mean_values_cont_SGP))),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
)
...
fig_bs_price <- plot_ly(x=dim1*(max_impl_vol-min_impl_vol)+min_impl_vol, y=dim2*(max_time-min_time)+min_time, z=matrix(y_mean_values_cont_bs, length(dim1*(max_impl_vol-min_impl_vol)+min_impl_vol), length(dim2*(max_time-min_time)+min_time)), type='surface', surfacecolor=color, colorscale='YlGnBu', cauto=F, cmin = min(y_mean_values_cont_SGP), cmax=max(y_mean_values_cont_SGP))
fig_bs_price <- fig_bs_price %>% add_surface(showscale = FALSE,contours = list(
  z = list(
    show=TRUE,
    usecolormap=FALSE,
...
fig_bs_sd <- plot_ly(x=dim1*(max_impl_vol-min_impl_vol)+min_impl_vol, y=dim2*(max_time-min_time)+min_time, z=matrix(y_sd_values_cont_bs, length(dim1*(max_impl_vol-min_impl_vol)+min_impl_vol), length(dim2*(max_time-min_time)+min_time)), type='surface',surfacecolor=color, colorscale='YlOrRd', cauto=F, cmin = min(y_mean_values_cont_SGP), cmax=max(y_mean_values_cont_SGP))
fig_bs_sd <- fig_bs_sd %>% add_surface(showscale = FALSE,contours = list(
  z = list(
    show=TRUE,
    usecolormap=FALSE,
...
fig_blackscholes_price <- plot_ly(x=dim1*(max_impl_vol-min_impl_vol)+min_impl_vol, y=dim2*(max_time-min_time)+min_time, z=matrix(blackscholes_test_cont, length(dim1*(max_impl_vol-min_impl_vol)+min_impl_vol), length(dim2*(max_time-min_time)+min_time)), type='surface',surfacecolor=color, colorscale='YlGnBu', cauto=F, cmin = min(y_mean_values_cont_SGP), cmax=max(y_mean_values_cont_SGP))
fig_blackscholes_price <- fig_blackscholes_price %>% add_surface(showscale = FALSE,contours = list(
  z = list(
    show=TRUE,
    usecolormap=FALSE,
...
fig_sgp_price <- plot_ly(x=dim1*(max_strike-min_strike)+min_strike, y=dim2*(max_impl_vol-min_impl_vol)+min_impl_vol, z=matrix(y_mean_values_cont_SGP, length(dim1*(max_strike-min_strike)+min_strike), length(dim2*(max_impl_vol-min_impl_vol)+min_impl_vol)), type='surface',surfacecolor=color, colorscale='YlGnBu', cauto=F, cmin = min(y_mean_values_cont_SGP), cmax=max(y_mean_values_cont_SGP))
fig_sgp_price <- fig_sgp_price %>% add_surface(showscale = FALSE,contours = list(
  z = list(
    show=TRUE,
    usecolormap=FALSE,
...
fig_sgp_price <- fig_sgp_price %>% layout(title = 'SGP', 
  scene = list(xaxis = list(title='Strike Price'), yaxis = list(title='Implied Volatility'), zaxis= list(title='Predicted Price', range = c(min(y_mean_values_cont_SGP),max(y_mean_values_cont_SGP))),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
)
...
fig_sgp_sd <- plot_ly(x=dim1*(max_strike-min_strike)+min_strike, y=dim2*(max_impl_vol-min_impl_vol)+min_impl_vol, z=matrix(y_sd_values_cont_SGP, length(dim1*(max_strike-min_strike)+min_strike), length(dim2*(max_impl_vol-min_impl_vol)+min_impl_vol)), type='surface',surfacecolor=color, colorscale='YlOrRd', cauto=F, cmin = min(y_mean_values_cont_SGP), cmax=max(y_mean_values_cont_SGP))
fig_sgp_sd <- fig_sgp_sd %>% add_surface(showscale = FALSE,contours = list(
  z = list(
    show=TRUE,
    usecolormap=FALSE,
...
fig_sgp_sd <- fig_sgp_sd %>% layout(title = 'SGP', 
  scene = list(xaxis = list(title='Strike Price'), yaxis = list(title='Implied Volatility'), zaxis= list(title='Standard Deviation', range = c(min(y_mean_values_cont_SGP),max(y_mean_values_cont_SGP))),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
)
...
fig_bs_price <- plot_ly(x=dim1*(max_strike-min_strike)+min_strike, y=dim2*(max_impl_vol-min_impl_vol)+min_impl_vol, z=matrix(y_mean_values_cont_bs, length(dim1*(max_strike-min_strike)+min_strike), length(dim2*(max_impl_vol-min_impl_vol)+min_impl_vol)), type='surface',surfacecolor=color, colorscale='YlGnBu', cauto=F, cmin = min(y_mean_values_cont_SGP), cmax=max(y_mean_values_cont_SGP))
fig_bs_price <- fig_bs_price %>% add_surface(showscale = FALSE,contours = list(
  z = list(
    show=TRUE,
    usecolormap=FALSE,
...
fig_bs_sd <- plot_ly(x=dim1*(max_strike-min_strike)+min_strike, y=dim2*(max_impl_vol-min_impl_vol)+min_impl_vol, z=matrix(y_sd_values_cont_bs, length(dim1*(max_strike-min_strike)+min_strike), length(dim2*(max_impl_vol-min_impl_vol)+min_impl_vol)),type='surface',surfacecolor=color, colorscale='YlOrRd', cauto=F, cmin = min(y_mean_values_cont_SGP), cmax=max(y_mean_values_cont_SGP))
fig_bs_sd <- fig_bs_sd %>% add_surface(showscale = FALSE,contours = list(
  z = list(
    show=TRUE,
    usecolormap=FALSE,
...
fig_blackscholes_price <- plot_ly(x=dim1*(max_strike-min_strike)+min_strike, y=dim2*(max_impl_vol-min_impl_vol)+min_impl_vol, z=matrix(blackscholes_test_cont, length(dim1*(max_strike-min_strike)+min_strike), length(dim2*(max_impl_vol-min_impl_vol)+min_impl_vol)), type='surface',surfacecolor=color, colorscale='YlGnBu', cauto=F, cmin = min(y_mean_values_cont_SGP), cmax=max(y_mean_values_cont_SGP))
fig_blackscholes_price <- fig_blackscholes_price %>% add_surface(showscale = FALSE,contours = list(
  z = list(
    show=TRUE,
    usecolormap=FALSE,
...
fig_bs_dis <- plot_ly(x=dim1*(max_spot-min_spot)+min_spot, y=dim2*(max_strike-min_strike)+min_strike, z=matrix(Discrepancy_function, length(dim1*(max_spot-min_spot)+min_spot), length(dim2*(max_strike-min_strike)+min_strike)), type='surface',surfacecolor=color, colorscale='Bluered', cauto=F, cmin = min(Discrepancy_function), cmax=max(Discrepancy_function))
...
fig_bs_dis <- fig_bs_dis %>% layout(title = 'BSGP', 
  scene = list(xaxis = list(title='Spot Price'), yaxis = list(title='Strike Price'), zaxis= list(title='Discrepancy', range = c(min(Discrepancy_function),max(Discrepancy_function))),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
)
...
fig_bs_dis <- plot_ly(x=dim1*(max_impl_vol-min_impl_vol)+min_impl_vol, y=dim2*(max_time-min_time)+min_time, z=matrix(Discrepancy_function, length(dim1*(max_impl_vol-min_impl_vol)+min_impl_vol), length(dim2*(max_time-min_time)+min_time)), type='surface',surfacecolor=color, colorscale='Picnic', cauto=F, cmin = min(Discrepancy_function), cmax=max(Discrepancy_function))
fig_bs_dis <- fig_bs_dis %>% add_surface(showscale = FALSE,contours = list(
  z = list(
    show=TRUE,
    usecolormap=FALSE,
...
fig_bs_dis <- fig_bs_dis %>% layout(title = 'BSGP', 
  scene = list(xaxis = list(title='Implied Volatility'), yaxis = list(title='Time to Expiration'), zaxis= list(title='Discrepancy', range = c(min(Discrepancy_function),max(Discrepancy_function))),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
)
...
fig_bs_dis <- plot_ly(x=dim1*(max_strike-min_strike)+min_strike, y=dim2*(max_impl_vol-min_impl_vol)+min_impl_vol, z=matrix(Discrepancy_function, length(dim1*(max_strike-min_strike)+min_strike), length(dim2*(max_impl_vol-min_impl_vol)+min_impl_vol)), type='surface', surfacecolor=color, colorscale='Portland', cauto=F, cmin = min(Discrepancy_function), cmax=max(Discrepancy_function))
fig_bs_dis <- fig_bs_dis %>% add_surface(showscale = FALSE,contours = list(
  z = list(
    show=TRUE,
    usecolormap=FALSE,
...
fig_bs_dis <- fig_bs_dis %>% layout(title = 'BSGP', 
  scene = list(xaxis = list(title='Strike Price'), yaxis = list(title='Implied Volatility'), zaxis= list(title='Discrepancy', range = c(min(Discrepancy_function),max(Discrepancy_function))),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
)
...
```{r uncertainty of delta}
post_data_bs_American_derivative <- list(theta=c(post_mean_theta_1_bs,post_mean_theta_2_bs,post_mean_theta_3_bs,post_mean_theta_4_bs,post_mean_theta_5_bs,post_mean_theta_6_bs),sigma2=post_mean_sigma2_bs,gamma2=post_mean_gamma2_bs,mu=post_mean_mu_bs,x_train=stan_dat$x,y1=stan_dat$y,x_test=x2,N1=length(stan_dat$x[,1]),N2=length(x2[,1]), bs = BS_Delta,variables = 6)
# post_data

posterior_derivative <- stan(file="Predictive GP_6dimension_withBS_SGP_derivative.stan", data=post_data_bs_American_derivative,iter=200, warmup=0, chains=1, seed=5838298, refresh=100, algorithm = 'Fixed_param')

#Computing Mean
y_predict_values_derivative <- extract(posterior_derivative,permuted=FALSE)
y_mean_values_derivative <- c(colMeans(y_predict_values_derivative))
y_mean_values_derivative <- y_mean_values_derivative[1:(length(y_mean_values_derivative)-1)]

#Computing Standard Deviation
pred_gp_summary_derivative <- summary(posterior_derivative, sd=c("sd"))$summary
pred_gp_sd_derivative <- pred_gp_summary_derivative[, c("sd")]
y_sd_values_derivative <- pred_gp_sd_derivative[1:(length(pred_gp_sd_derivative)-1)]
```
...
x.grid_4_cont <- as.numeric(rep(mean(stan_dat$total_puts_American$impl_volatility_scaled[test_start:test_end])),nrow(X.grid))
x.grid_5_cont <- as.numeric(rep(mean(stan_dat$total_puts_American$dividend_yield_scaled[test_start:test_end])),nrow(X.grid))
x.grid_6_cont <- as.numeric(rep(mean(stan_dat$total_puts_American$interest_rate_scaled[test_start:test_end])),nrow(X.grid))
...
x.grid_4_cont_bs <- as.numeric(rep(mean(stan_dat$total_puts_American$impl_volatility[test_start:test_end])),nrow(X.grid))
x.grid_5_cont_bs <- as.numeric(rep(mean(stan_dat$total_puts_American$dividend_yield[test_start:test_end])),nrow(X.grid))
x.grid_6_cont_bs <- as.numeric(rep(mean(stan_dat$total_puts_American$interest_rate[test_start:test_end])),nrow(X.grid))
...
color <- matrix(BSGP_Delta_cont, length(dim1*(max_strike-min_strike)+min_strike), length(dim2*(max_spot-min_spot)+min_spot))
dim(color) <- dim(matrix(BSGP_Delta_cont, length(dim1*(max_strike-min_strike)+min_strike), length(dim2*(max_spot-min_spot)+min_spot)))

fig_bs <- plot_ly(x=dim1*(max_strike-min_strike)+min_strike, y=dim2*(max_spot-min_spot)+min_spot, z=matrix(BSGP_Delta_cont, length(dim1*(max_strike-min_strike)+min_strike), length(dim2*(max_spot-min_spot)+min_spot)), type='surface',surfacecolor=color, colorscale='Hot', cauto=F, cmin = min(BSGP_Delta_cont), cmax=max(BSGP_Delta_cont))
...
fig_bs <- fig_bs %>% layout(title = 'BSGP', 
  scene = list(xaxis = list(title='Strike Price'), yaxis = list(title='Spot Price'), zaxis= list(title='Delta', range = c(min(BSGP_Delta_cont),max(BSGP_Delta_cont))),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
)
...
color <- matrix(BS_Delta_cont, length(dim1*(max_strike-min_strike)+min_strike), length(dim2*(max_spot-min_spot)+min_spot))
dim(color) <- dim(matrix(BS_Delta_cont, length(dim1*(max_strike-min_strike)+min_strike), length(dim2*(max_spot-min_spot)+min_spot)))

fig_blackscholes <- plot_ly(x=dim1*(max_strike-min_strike)+min_strike, y=dim2*(max_spot-min_spot)+min_spot, z=matrix(BS_Delta_cont, length(dim1*(max_strike-min_strike)+min_strike), length(dim2*(max_spot-min_spot)+min_spot)), type='surface',surfacecolor=color, colorscale='Hot', cauto=F, cmin = min(BS_Delta_cont), cmax=max(BS_Delta_cont))
...
fig_blackscholes <- fig_blackscholes %>% layout(title = 'Black-Scholes', 
  scene = list(xaxis = list(title='Strike Price'), yaxis = list(title='Spot Price'),zaxis= list(title='Delta', range = c(min(BS_Delta_cont),max(BS_Delta_cont))),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
)
...
color <- matrix(Delta_disc, length(dim1*(max_strike-min_strike)+min_strike), length(dim2*(max_spot-min_spot)+min_spot))
dim(color) <- dim(matrix(Delta_disc, length(dim1*(max_strike-min_strike)+min_strike), length(dim2*(max_spot-min_spot)+min_spot)))

fig_disc <- plot_ly(x=dim1*(max_strike-min_strike)+min_strike, y=dim2*(max_spot-min_spot)+min_spot, z=matrix(Delta_disc, length(dim1*(max_strike-min_strike)+min_strike), length(dim2*(max_spot-min_spot)+min_spot)), type='surface',colorscale='Cividis', cauto=F, cmin = min(Delta_disc), cmax=max(Delta_disc))
...
fig_disc <- fig_disc %>% layout(title = 'BSGP', 
  scene = list(xaxis = list(title='Strike Price'), yaxis = list(title='Spot Price'), zaxis= list(title='Delta Discrepancy', range = c(min(Delta_disc),max(Delta_disc))),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
)
...
fig_bs <- plot_ly(x=dim1*(max_impl_vol-min_impl_vol)+min_impl_vol, y=dim2*(max_time-min_time)+min_time, z=matrix(BSGP_Delta_cont, length(dim1*(max_impl_vol-min_impl_vol)+min_impl_vol), length(dim2*(max_time-min_time)+min_time)), type='surface',colorscale='Hot', cauto=F, cmin = min(BSGP_Delta_cont), cmax=max(BSGP_Delta_cont))
fig_bs <- fig_bs %>% add_surface(showscale = FALSE,contours = list(
  z = list(
    show=TRUE,
    usecolormap=FALSE,
...
fig_bs <- fig_bs %>% layout(title = 'BSGP', 
  scene = list(xaxis = list(title='Implied Volatility'), yaxis = list(title='Time to Expiration'), zaxis= list(title='Delta', range = c(min(BSGP_Delta_cont),max(BSGP_Delta_cont))),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
)
...
fig_blackscholes <- plot_ly(x=dim1*(max_impl_vol-min_impl_vol)+min_impl_vol, y=dim2*(max_time-min_time)+min_time, z=matrix(BS_Delta_cont, length(dim1*(max_impl_vol-min_impl_vol)+min_impl_vol), length(dim2*(max_time-min_time)+min_time)), type='surface',colorscale='Hot', cauto=F, cmin = min(BS_Delta_cont), cmax=max(BS_Delta_cont))
fig_blackscholes <- fig_blackscholes %>% add_surface(showscale = FALSE,contours = list(
  z = list(
    show=TRUE,
    usecolormap=FALSE,
...
fig_blackscholes <- fig_blackscholes %>% layout(title = 'Black-Scholes', 
  scene = list(xaxis = list(title='Implied Volatility'), yaxis = list(title='Time to Expiration'), zaxis= list(title='Delta', range = c(min(BS_Delta_cont),max(BS_Delta_cont))),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
)
...
fig_disc <- plot_ly(x=dim1*(max_impl_vol-min_impl_vol)+min_impl_vol, y=dim2*(max_time-min_time)+min_time, z=matrix(Delta_disc, length(dim1*(max_impl_vol-min_impl_vol)+min_impl_vol), length(dim2*(max_time-min_time)+min_time)), type='surface',colorscale='Cividis', cauto=F, cmin = min(Delta_disc), cmax=max(Delta_disc))
fig_disc <- fig_disc %>% add_surface(showscale = FALSE,contours = list(
  z = list(
    show=TRUE,
    usecolormap=FALSE,
...
fig_disc <- fig_disc %>% layout(title = 'BSGP', 
  scene = list(xaxis = list(title='Implied Volatility'), yaxis = list(title='Time to Expiration'), zaxis= list(title='Delta Discrepancy', range = c(min(Delta_disc),max(Delta_disc))),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
)
...
fig_bs <- plot_ly(x=dim1*(max_strike-min_strike)+min_strike, y=dim2*(max_impl_vol-min_impl_vol)+min_impl_vol, z=matrix(BSGP_Delta_cont, length(dim1*(max_strike-min_strike)+min_strike), length(dim2*(max_impl_vol-min_impl_vol)+min_impl_vol)), type='surface',colorscale='Hot', cauto=F, cmin = min(BSGP_Delta_cont), cmax=max(BSGP_Delta_cont))
fig_bs <- fig_bs %>% add_surface(showscale = FALSE,contours = list(
  z = list(
    show=TRUE,
    usecolormap=FALSE,
...
fig_bs <- fig_bs %>% layout(title = 'BSGP', 
  scene = list(xaxis = list(title='Strike Price'), yaxis = list(title='Implied Volatility'), zaxis= list(title='Delta', range = c(min(BSGP_Delta_cont),max(BSGP_Delta_cont))),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
)
...
fig_blackscholes <- plot_ly(x=dim1*(max_strike-min_strike)+min_strike, y=dim2*(max_impl_vol-min_impl_vol)+min_impl_vol, z=matrix(BS_Delta_cont, length(dim1*(max_strike-min_strike)+min_strike), length(dim2*(max_impl_vol-min_impl_vol)+min_impl_vol)), type='surface',colorscale='Hot', cauto=F, cmin = min(BS_Delta_cont), cmax=max(BS_Delta_cont))
fig_blackscholes <- fig_blackscholes %>% add_surface(showscale = FALSE,contours = list(
  z = list(
    show=TRUE,
    usecolormap=FALSE,
...
fig_blackscholes <- fig_blackscholes %>% layout(title = 'Black-Scholes', 
  scene = list(xaxis = list(title='Strike Price'), yaxis = list(title='Implied Volatility'), zaxis= list(title='Delta', range = c(min(BS_Delta_cont),max(BS_Delta_cont))),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
)
...
fig_disc <- plot_ly(x=dim1*(max_strike-min_strike)+min_strike, y=dim2*(max_impl_vol-min_impl_vol)+min_impl_vol, z=matrix(Delta_disc, length(dim1*(max_strike-min_strike)+min_strike), length(dim2*(max_impl_vol-min_impl_vol)+min_impl_vol)), type='surface',colorscale='Cividis', cauto=F, cmin = min(Delta_disc), cmax=max(Delta_disc))
fig_disc <- fig_disc %>% add_surface(showscale = FALSE,contours = list(
  z = list(
    show=TRUE,
    usecolormap=FALSE,
...
fig_disc <- fig_disc %>% layout(title = 'BSGP', 
  scene = list(xaxis = list(title='Strike Price'), yaxis = list(title='Implied Volatility'), zaxis= list(title='Delta Discrepancy', range = c(min(Delta_disc),max(Delta_disc))),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
)
