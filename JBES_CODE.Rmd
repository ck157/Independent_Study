...
color <- matrix(BSGP_Delta_cont, length(dim1*(max_spot-min_spot)+min_spot), length(dim2*(max_strike-min_strike)+min_strike))
dim(color) <- dim(matrix(BSGP_Delta_cont, length(dim1*(max_spot-min_spot)+min_spot), length(dim2*(max_strike-min_strike)+min_strike)))

fig_bs <- plot_ly(x=dim1*(max_spot-min_spot)+min_spot, y=dim2*(max_strike-min_strike)+min_strike, z=matrix(BSGP_Delta_cont, length(dim1*(max_spot-min_spot)+min_spot), length(dim2*(max_strike-min_strike)+min_strike)), type='surface',surfacecolor=color,
        colors=c('blue','red'))
...
fig_bs <- fig_bs %>% layout(title = 'BSGP', 
  scene = list(xaxis = list(title='Spot Price'), yaxis = list(title='Strike Price'), zaxis= list(title='Delta'),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
)
...
color <- matrix(BS_Delta_cont, length(dim1*(max_spot-min_spot)+min_spot), length(dim2*(max_strike-min_strike)+min_strike))
dim(color) <- dim(matrix(BS_Delta_cont, length(dim1*(max_spot-min_spot)+min_spot), length(dim2*(max_strike-min_strike)+min_strike)))

fig_blackscholes <- plot_ly(x=dim1*(max_spot-min_spot)+min_spot, y=dim2*(max_strike-min_strike)+min_strike, z=matrix(BS_Delta_cont, length(dim1*(max_spot-min_spot)+min_spot), length(dim2*(max_strike-min_strike)+min_strike)), type='surface',surfacecolor=color,
        colors=c('blue','yellow'))
...
fig_blackscholes <- fig_blackscholes %>% layout(title = 'BSGP', 
  scene = list(xaxis = list(title='Spot Price'), yaxis = list(title='Strike Price'), zaxis= list(title='Delta'),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
...
color <- matrix(Delta_disc, length(dim1*(max_spot-min_spot)+min_spot), length(dim2*(max_strike-min_strike)+min_strike))
dim(color) <- dim(matrix(Delta_disc, length(dim1*(max_spot-min_spot)+min_spot), length(dim2*(max_strike-min_strike)+min_strike)))

fig_disc <- plot_ly(x=dim1*(max_spot-min_spot)+min_spot, y=dim2*(max_strike-min_strike)+min_strike, z=matrix(Delta_disc, length(dim1*(max_spot-min_spot)+min_spot), length(dim2*(max_strike-min_strike)+min_strike)), type='surface',surfacecolor=color,
        colors=c('yellow','red'))
...
fig_disc <- fig_disc %>% layout(title = 'BSGP', 
  scene = list(xaxis = list(title='Spot Price'), yaxis = list(title='Strike Price'), zaxis= list(title='Delta Discrepancy'),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
)
