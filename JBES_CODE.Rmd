...
vector_k_values_cont <- stan(file="Predictive GP_6dimension_withBS_SGP_vectork.stan", data=post_data_cont_bs,iter=200, warmup=0, chains=1, seed=5838298, refresh=100, algorithm = 'Fixed_param')
...
persp(dim1, dim2, z, phi = 45, theta = 315, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab="Spot Price", ylab = "Strike Price", zlab = "Average Price", main = "BSGP Deltas (Spot Price & Strike Price)")
...
persp(dim1, dim2,z, phi = 45, theta = 315, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab="Spot Price", ylab = "Strike Price", zlab = "Average Price", main = "BlackScholes Deltas (Spot Price & Strike Price)")
#Contour of Variance
...
par(mfrow = c(1, 2))
#Contour for Predictions aka mean values of predicitons
z <-  matrix(BS_Delta, length(dim1), length(dim2))
