...
fig_bs <- plot_ly(x=dim1*(max_strike-min_strike)+min_strike, y=dim2*(max_spot-min_spot)+min_spot, z=matrix(BSGP_Delta_cont, length(dim1*(max_strike-min_strike)+min_strike), length(dim2*(max_spot-min_spot)+min_spot)), type='surface',surfacecolor=color,
        colors=c('blue','red'))
...
fig_bs <- fig_bs %>% layout(title = 'BSGP', 
  scene = list(xaxis = list(title='Strike Price'), yaxis = list(title='Spot Price'), zaxis= list(title='Delta'),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
)
...
fig_blackscholes <- plot_ly(x=dim1*(max_strike-min_strike)+min_strike, y=dim2*(max_spot-min_spot)+min_spot, z=matrix(BS_Delta_cont, length(dim1*(max_strike-min_strike)+min_strike), length(dim2*(max_spot-min_spot)+min_spot)), type='surface',surfacecolor=color,
        colors=c('blue','red'))
...
fig_disc <- plot_ly(x=dim1*(max_strike-min_strike)+min_strike, y=dim2*(max_spot-min_spot)+min_spot, z=matrix(Delta_disc, length(dim1*(max_strike-min_strike)+min_strike), length(dim2*(max_spot-min_spot)+min_spot)), type='surface',surfacecolor=color,
        colors=c('yellow','red'))
...
fig_disc <- fig_disc %>% layout(title = 'BSGP', 
  scene = list(xaxis = list(title='Strike Price'), yaxis = list(title='Spot Price'), zaxis= list(title='Delta Discrepancy'),camera = list(
    eye=list(x=-1.25,y=-1.25,z=1.25)
  )
  )
)
