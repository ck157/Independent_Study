...
fig_sgp_price <- fig_sgp_price %>% layout(title = 'SGP', 
  scene = list(xaxis = list(title='Spot Price'), yaxis = list(title='Strike Price'), zaxis= list(title='Predicted Price')
  )
)
...
persp(dim1, dim2,z, phi = 45, theta = 225, border="grey80",col=colors[z.facet.range],shade=0.4,expand=0.4, nticks = 2,ticktype="detailed",xlab="Implied Volatility", ylab = "Time to Expiration", zlab = "Delta", main = "BS Deltas (Implied_vol & Time_to_exp)")
#Contour of Variance
