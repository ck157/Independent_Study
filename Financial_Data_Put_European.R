...
library(dplyr)
library(stringr)
total_puts <- read_csv("C:/Users/CK/Desktop/CK/Duke/Honors Thesis/Data/spy_spx_(2019.06.01~2019.06.30)_Puts.xlsb.csv")
...
total_puts_European <- total_puts[(total_puts$volume>50 &
                                  (total_puts$time_to_exp<=3.712&total_puts$time_to_exp>=0.776)), ]
